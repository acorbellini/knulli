...
# Fix SDL2_net/SDL2_mixer cmake configs that have hardcoded exec_prefix=/usr
# which causes cross-compilation to link against host libraries
define ECWOLF_FIX_SDL_CMAKE_CONFIGS
	$(SED) 's|set(exec_prefix "/usr")|set(exec_prefix "$${prefix}")|' \
		$(STAGING_DIR)/usr/lib/cmake/SDL2_net/sdl2_net-config.cmake \
		$(STAGING_DIR)/usr/lib/cmake/SDL2_mixer/sdl2_mixer-config.cmake
endef
ECWOLF_PRE_CONFIGURE_HOOKS += ECWOLF_FIX_SDL_CMAKE_CONFIGS
